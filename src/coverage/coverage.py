...
if __name__ == '__main__':
    ...
    R("par(mfrow=c(2,1))")
    R.plot(lCoverage, plotClSens, type="b", main="Coverage vs reconstruction sensitivity", xlab="coverage", ylab="sensitivity", log="x", col=2, ylim=R.c(0,1), pch=2, cex=cExfact)
    ...
    R.plot(lCoverage, plotClPrec, type="b", main="Coverage vs reconstruction precision", xlab="coverage", ylab="precision", log="x", col=2, ylim=R.c(0,1), pch=2, cex=cExfact)
